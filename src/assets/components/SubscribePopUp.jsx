      ...
      <Modal open={open} onClose={handleClose}>
        ...
        <Modal.Body>
            <div className='flex flex-col items-center'>
                ...
                <div className='text-center '>Enter your email to get the update on Adesola Plastics Store's hottest deals, exclusive offers, early access to sales and more.<br />Don't miss out</div>
