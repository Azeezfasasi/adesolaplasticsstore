            ...
            {cart.items.length > 0 && (
              <div className="flex justify-end mt-6">
                <button
                  ...
                  className="bg-gray-200 text-gray-800 font-semibold py-2 px-4 rounded-md transition duration-300 ease-in-out flex items-center gap-2 hover:bg-orange-500 hover:text-white cursor-pointer"
                >
                  <FaTrash /> Clear Cart
                </button>
              </div>
