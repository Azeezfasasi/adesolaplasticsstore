          ...
          >
            ...
            <div className="p-4 flex flex-col flex-grow">
              ...
              <div className="flex items-center mb-4">
                {product.onSale ? (
                  <>
                    <p className="text-lg font-bold text-orange-500 mr-2">
              ...
              <div className="flex flex-col space-y-3">
                <button
                  ...
                  className="flex items-center justify-center bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 cursor-pointer"
                >
