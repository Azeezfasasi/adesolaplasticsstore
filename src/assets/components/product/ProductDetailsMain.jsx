              ...
              <div className="flex flex-row gap-2 overflow-x-auto pb-2 scrollbar-thumb-rounded scrollbar-track-rounded scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
                {product.images.map((image, index) => (
                  <button
                    ...
                    ${selectedImage === index ? 'ring-2 ring-orange-500' : 'hover:opacity-75'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500`}
                  >
                    <img
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className={`flex-1 bg-orange-500 text-white px-6 py-3 rounded-md hover:bg-orange-600 flex items-center justify-center gap-2 transition-colors duration-200 cursor-pointer
