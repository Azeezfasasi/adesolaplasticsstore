    ...
    <div className="min-h-screen bg-white font-inter flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center text-center lg:text-left">
          <p className="text-orange-600 uppercase tracking-wide text-[18px] mb-4 font-semibold">Our Vision</p>
          <h1 className="text-[25px] sm:text-[30px] lg:text-[32px] font-bold text-gray-800 leading-tight mb-6">
            To be Nigeria's most trusted and innovative provider of plastic products, setting the benchmark for quality, sustainability, and customer satisfaction in every home and business we serve.
          </h1>
          <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
            We envision a future where Adesola Plastics Store is synonymous with reliability, eco-friendly solutions, and continuous improvement. Our commitment is to lead the plastics industry by embracing modern technology, responsible manufacturing, and a customer-first mindset.<br /><br />
