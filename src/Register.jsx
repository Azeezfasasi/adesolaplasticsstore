...
function Register() {
  ...
  return (
    <>
      <Helmet>
        <title>Register - Adesola Plastics Store</title>
      </Helmet>
      <TopHeader />
      <MainHeader />
      <div className="flex justify-center items-center min-h-[60vh] bg-gray-100 py-8">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#00B9F1] hover:bg-[#00A1D1] text-white font-semibold py-3 px-6 rounded-full transition text-lg"
          >
